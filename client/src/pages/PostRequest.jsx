...
export default function PostRequest() {
  ...
  const startDistrict = user?.location?.district && DISTRICTS[user.location.district]
  ...
  return (
    <div className="container">
      <h1 className="page-title">Post Request</h1>
      <p className="page-sub">Choose a need, pin the location, and submit the request.</p>
